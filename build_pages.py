...
pages["about"] = dict(title="About — ETC Labs — Gen 1", desc="What ETC Labs — Gen 1 is, why it exists, what it is experimenting with, how things are built, the design and technology philosophy, and where it is going. An independent showcase, not affiliated with MXT.", body=f'''
    ...
    <section class="section" id="who" data-tone="cyan" aria-labelledby="team-title"><div class="container">{head("Who is behind it", "One builder, for now.", "No invented team. ETC Labs — Gen 1 is designed, built, tested, deployed and documented by one person.", "team-title")}<div class="team-grid" id="team"></div></div></section>
